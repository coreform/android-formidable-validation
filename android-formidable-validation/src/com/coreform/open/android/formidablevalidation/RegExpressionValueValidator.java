...
public class RegExpressionValueValidator extends AbstractValueValidator {
	...
	/*
	public RegExpressionValueValidator(String expression) {
		//for lindo way v#2, this should be one of the two usual ways to instantiate since validators are added to a field in the ValidatorMap
		setExpression(expression);
	}
	
	public RegExpressionValueValidator(String expression, String faultMessage) {
		//for lindo way v#2, this should be one of the two usual ways to instantiate since validators are added to a field in the ValidatorMap
		setExpression(expression);
