...
public class SetErrorAbleCheckBox extends CheckBox implements SetErrorAble {
	private Context mContext;
	private SetErrorHandler mSetErrorHandler;
	
	public SetErrorAbleCheckBox(Context context) {
		super(context);
		mContext = context;
	...
	public SetErrorAbleCheckBox(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		mSetErrorHandler = new SetErrorHandler(context, this);
		setupListeners();
	...
	public SetErrorAbleCheckBox(Context context, AttributeSet attrs, int defStyle) {
